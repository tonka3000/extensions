...
import { TweetSendV2Form } from "./send";
...
export function ShowDetailV2Action(props: { tweet: Tweet }): ReactElement {
  return <Action.Push title="Show Tweet" target={<TweetDetailV2 tweet={props.tweet} />} />;
}
...
export function ReplyTweetV2Action(props: { tweet: Tweet }) {
  return (
    <Action.Push
      title="Reply"
      target={<TweetSendV2Form replyTweet={props.tweet} />}
